...
After verifying the downloaded tarball and authenticating the intended npm account:
...
Registry publication is intentionally not automatic: Git tags, GitHub artifacts, and npm publication are separate external side effects. Do not reuse a version after any registry publish succeeds.
